"""hard-digitalu-hf1 --lr 0 CONTROL: marker-relative parser + tree:quotient DigitALU +
...
LOOPS=16 EVAL_LOOPS=64 MAXQ=10 batch=128.
"""
...
N_CARRY = 2
N_BORROW = 2
MAX_QUOT = 10     # alphabet of the learned quotient digit
TRAIN_LOOPS_EASY = 3
TRAIN_LOOPS_DEEP = 16
EVAL_LOOPS = 64
DIGIT_TAU = 0.5
