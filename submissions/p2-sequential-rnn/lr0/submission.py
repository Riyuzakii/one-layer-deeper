...
D_H = 64            # width of the recurrent state.  THE memorisation/generalisation dial.
D_EMB = 64          # token/position embedding width
LOOPS = 1           # tied applications of (encode -> carry-scan decode)
