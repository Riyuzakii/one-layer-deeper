...
EVAL_LOOPS = 16           # LAB VARIANT: fixed 16 loops, no early exit -- emulates the iteration count a CORRECTLY TRAINED controller spends over the 16 scoring splits (2x127 ladder + test + ood ~ 260 ~ 16x16)
DIGIT_TAU = 0.5
